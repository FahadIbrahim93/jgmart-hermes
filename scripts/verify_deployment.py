...
def verify_deployment(base_url):
    ...
    if index_content:
        ...
        status = f"{Colors.GREEN}✅{Colors.RESET}" if has_wa else f"{Colors.RED}❌{Colors.RESET}"
        ...
        status = f"{Colors.GREEN}✅{Colors.RESET}" if has_theme else f"{Colors.RED}❌{Colors.RESET}"
        ...
        status = f"{Colors.GREEN}✅{Colors.RESET}" if has_viewport else f"{Colors.RED}❌{Colors.RESET}"
        ...
        status = f"{Colors.GREEN}✅{Colors.RESET}" if has_doctype else f"{Colors.RED}❌{Colors.RESET}"
        ...
        status = f"{Colors.GREEN}✅{Colors.RESET}" if has_products else f"{Colors.YELLOW}⚠️{Colors.RESET}"
        log(f"  {status} Product catalog: {'Loaded' if has_products else 'Check manually'}")
    ...
    if zone_content:
        ...
        status = f"{Colors.GREEN}✅{Colors.RESET}" if has_buildings else f"{Colors.YELLOW}⚠️{Colors.RESET}"
        log(f"  {status} Building references: {'Found' if has_buildings else 'Check manually'}")
