...
SVGS["rice_dal"] = make_svg(
    ...
    [
        ...
        # rice grains
        (
            "M105,125 Q110,105 120,110 Q130,100 140,110 Q150,95 160,108 Q170,100 180,112 Q190,102 195,115",
            "#FFF",
            0.8,
        ),
        (
            "M110,118 Q118,108 128,115 Q138,105 148,114 Q158,102 168,112 Q178,104 188,115",
            "#FFF",
            0.5,
        ),
        # steam
...
SVGS["oil_spices"] = make_svg(
    ...
    [
        ...
        # oil drop
        (
            "M140,100 C140,108 145,110 148,110 C151,110 155,108 155,100 C155,95 148,85 148,85 C148,85 140,95 140,100",
            "#FDBB2D",
            0.7,
        ),
        # spice dots
...
SVGS["vegetables"] = make_svg(
    ...
    [
        ...
        (
            "M120,120 Q110,90 120,80 Q115,60 130,65 Q140,45 155,60 Q170,45 180,65 Q195,60 190,80 Q200,90 190,120 Z",
            "#4CAF50",
            0.85,
        ),
        # stem
...
SVGS["fish"] = make_svg(
    ...
    [
        # fish body
        (
            "M90,130 Q90,80 150,100 Q210,80 210,130 Q210,170 150,150 Q90,170 90,130 Z",
            "#90CAF9",
            0.9,
        ),
        # tail
...
SVGS["meat"] = make_svg(
    ...
    [
        ...
        (
            "M130,180 Q100,180 90,160 Q80,140 85,120 Q90,105 100,105 Q110,105 115,115 Q120,100 135,95 Q150,90 160,95 Q170,100 175,115 Q180,110 190,115 Q200,120 200,140 Q200,160 180,175 Q165,185 150,180 Z",
            "#EF9A9A",
            0.9,
        ),
...
SVGS["fruits"] = make_svg(
    ...
    [
        ...
        # banana arc
        (
            "M80,150 Q75,130 90,115 Q100,100 115,105 Q110,115 100,130 Q90,145 85,155 Z",
            "#FFF176",
            0.85,
        ),
        # grapes (bunch)
...
SVGS["fmcg"] = make_svg(
    ...
    [
        ...
        # spray mist
        (
            "M145,28 Q140,20 135,22 Q130,18 125,24 Q120,20 118,28",
            "rgba(255,255,255,0.3)",
            1,
        ),
        (
            "M150,28 Q155,18 160,22 Q165,16 170,24 Q175,18 178,26",
...
SVGS["snacks"] = make_svg(
    ...
    [
        ...
        (
            "M90,185 Q100,175 110,185 Q120,175 130,185 Q140,175 150,185 Q160,175 170,185 Q180,175 190,185 Q195,175 200,185",
            "#FFCC80",
            0.85,
        ),
        # label area
...
SVGS["placeholder"] = make_svg(
    ...
    [
        # circle background
        (
            "M150,70 A40,40 0 1,1 150,150 A40,40 0 1,1 150,70",
...
def main():
    ...
    written.append(
        ("placeholder.svg", len(SVGS.get("placeholder", "").encode("utf-8")) / 1024)
    )
